...
@stop
  ...
  <div class="container">
    @include('home-components.bidding.header')
  </div>
  <div class="container">
    ...
    <div class="container my-2">
      <div class="row">
        <div class="col-sm-3">
          ...
          <form action="{{ route('site.bidding.search', [$yearActive]) }}" method="get">
            <div class="card">
              ...
              <div class="card-body">
                <div class="form-group">
                  <div class="input-group input-group-lg">
                    ...
                    placeholder="Processo ou Objeto" name="q">
        ...
        <div class="col-sm-9">
          <div class="d-flex justify-content-between">
            ...
            <div class="p-2">
              <a href="{{route('site.bidding.grafic', $yearActive)}}" class="text-uppercase btn hover border">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                @foreach ($biddings as $bidding)
                  <tr>
                    <td class="text-center align-middle"><strong>{{ $bidding->year . '/' . $bidding->number }}</strong>
                    </td>
                    <td class="text-break text-justify">
                      {{ strip_tags(html_entity_decode($bidding->object, ENT_COMPAT, 'UTF-8')) }}</td>
                    ...
                    <td class="text-center align-middle">{{ (isset($bidding->event_date)) ? date('d/m/Y', strtotime($bidding->event_date)) : '-'; }}
                      {{ (isset($bidding->event_time)) ? date('H:i', strtotime($bidding->event_time)) : ''; }}</td>
                    <td class="text-center align-middle">
                      <a href="{{ route('site.bidding.index', $bidding) }}" class="btn btn-primary">
                        <i class="fa fa-eye"></i>
                      </a>
                    </td>
                  </tr>
      ...
      <div class="container">
        <div class="card my-5">
          <div class="card-body">
            ...
            <a class=" btn btn-primary text-uppercase" href="{{route('site.bidding.index', $yearActive)}}"> <i class="fa fa-arrow-left"></i> voltar</a>
          </div>
