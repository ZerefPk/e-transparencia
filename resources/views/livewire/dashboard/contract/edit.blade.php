...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Contrato: Editar</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Editar Contrato {{$contract->getRealNumber()}}</h3>
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <div wire:ignore>
                            ...
                            <select class="form-control" id="provider-select" style="width: 100%">
                                ...
                                @foreach ($providers as $provider)
                                    <option value="{{ $provider->id }}" @if($provider->id == $contract->provider_id) selected @endif>{{ $provider->type ? $provider->cnpj : $provider->cpf }} -
                        ...
                        <div wire:ignore>
                            ...
                            <select class="form-control" id="bidding-select" style="width: 100%">
                                ...
                                @foreach ($biddings as $bidding)
                                    <option value="{{ $bidding->id }}" @if($bidding->id == $contract->bidding_id) selected @endif>{{$bidding->getRealNumber()}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
