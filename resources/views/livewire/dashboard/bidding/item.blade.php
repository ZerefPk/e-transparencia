            ...
            <table class="table table-bordered">
                <thead>
                    <tr class="text-center">
                        ...
                        <th><button type="button" data-toggle="modal" data-target="#remove"
                                class="btn btn-danger btn-block"><i class="fa fa-trash"></i> Remover</button>
                            <!-- Modal -->
                            <div class="modal fade" id="remove" data-backdrop="static" tabindex="-1" role="dialog"
                                aria-labelledby="removeLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="removeLabel">Remover grupo:
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            Caso o grupo removido, os itens agrupados ficaram sem vinculos.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal">Cancelar</button>
                                            {{ Form::open(['route' => ['dashboard.bidding.group.delete', $bidding, $biddingGroup], 'method' => 'delete']) }}
                ...
                <tbody>
                    @foreach ($biddingGroup->biddindItens as $itemGroup)
                        <tr>
                            ...
                            <td>{{ $itemGroup->item }}</td>
                            <td>{!! $itemGroup->description !!}</td>
                            <td>{{ $itemGroup->unity }}</td>
                            <td>{{ $itemGroup->quantity }}</td>
                            <td>R$
                                {{ number_format($itemGroup->estimated_total_value / $itemGroup->quantity, 2, ',', '.') }}
                            </td>
                            <td>R$ {{ number_format($itemGroup->estimated_total_value, 2, ',', '.') }}</td>
                            <td class="text-center" style="width: 10%">
                                <a href="{{ route('dashboard.bidding.item.edit', [$bidding, $itemGroup]) }}"
